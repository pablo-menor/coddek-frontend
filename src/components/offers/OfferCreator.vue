        ...
        <div class="creator-panel">
            ...
            <section class="main-details">
                ...
                <div class="details-mobile">
                    ...
                    Sueldo: 
                    <input type="text" placeholder="Mín" class="input" v-model="minSalary">
                    -
                    <input type="text" placeholder="Máx" class="input" v-model="maxSalary">
                    €
                    </span>
                    <span class="detail-mobile">
                    <svg
                    ...
                    Experiencia: 
                    <input type="text" placeholder="experiencia mínima" class="input" v-model="experience">
                    </span>
                    <span class="detail-mobile">
                    <svg
                        width="14"
                    ...
                    Localización: 
                    <input type="text" placeholder="Ciudad" class="input" v-model="location">
                    </span>
                </div>
            </section>
            <section class="description">
                ...
                <button class="challange-details" @click="createOffer()">Crear oferta</button>
            </section>
